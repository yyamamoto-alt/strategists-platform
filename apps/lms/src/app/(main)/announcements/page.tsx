...
const priorityColors: Record<AnnouncementPriority, string> = { low: "border-l-gray-500", normal: "border-l-blue-500", high: "border-l-orange-500", urgent: "border-l-red-500" };
const priorityBadges: Record<AnnouncementPriority, string> = { low: "bg-gray-700 text-gray-300", normal: "bg-blue-900/50 text-blue-300", high: "bg-orange-900/50 text-orange-300", urgent: "bg-red-900/50 text-red-300" };
    ...
    <div className="p-6 bg-gray-950 min-h-screen">
      ...
      <div className="space-y-3">
        {mockAnnouncements.map((a) => {
          ...
          return (
            <div key={a.id} className={`bg-gray-800 rounded-xl border-l-4 ${priorityColors[a.priority]} overflow-hidden`}>
              ...
              {isExpanded && <div className="px-4 pb-4 border-t border-gray-700 pt-3"><p className="text-sm text-gray-300 whitespace-pre-wrap">{a.content}</p></div>}
            </div>
          );
        })}
      </div>
