...
const SECTIONS: SettingsSectionConfig[] = [
  ...
  {
    title: "Jicoo空き枠モニタリング",
    description: "Jicooの空き枠を定期チェックし、不足時にSlackでアラートを送信します（月・水・金 9:00 JST）。",
    fields: [
      {
        key: "slack_notify_jicoo_availability",
        label: "空き枠レポート通知",
        type: "toggle",
      },
      {
        key: "slack_channel_jicoo_availability",
        label: "└ 通知先チャンネル",
        type: "slack_channel",
        placeholder: "チャンネルを選択...",
      },
      {
        key: "jicoo_availability_total_days",
        label: "分析対象日数",
        type: "number",
        min: 7,
        max: 30,
      ...
      {
        key: "jicoo_availability_near_threshold",
        label: "今後5日間の閾値（以下でアラート）",
        type: "number",
        min: 0,
        suffix: "枠",
        placeholder: "4",
      ...
      {
        key: "jicoo_availability_total_threshold",
        label: "全体の閾値（以下でアラート）",
        type: "number",
        min: 0,
        suffix: "枠",
      ...
      {
        key: "jicoo_availability_mid_threshold",
        label: "4〜10日目の閾値（未満でアラート）",
        type: "number",
        min: 0,
        suffix: "枠",
        placeholder: "3",
      ...
      {
        key: "jicoo_availability_far_threshold",
        label: "10日目以降の閾値（未満でアラート）",
        type: "number",
        min: 0,
        suffix: "枠",
        placeholder: "3",
      ...
      {
        key: "jicoo_availability_evening_threshold",
        label: "平日夜+土日の閾値（以下でアラート）",
        type: "number",
        min: 0,
        suffix: "枠",
        placeholder: "6",
